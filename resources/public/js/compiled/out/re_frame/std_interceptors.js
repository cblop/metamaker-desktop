...
var vec__9799_9802 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_9803 = cljs.core.nth.call(null,vec__9799_9802,(0),null);
var only_after_9804 = cljs.core.nth.call(null,vec__9799_9802,(1),null);
var db_changed_QMARK__9805 = (cljs.core.some_QMARK_.call(null,only_before_9803)) || (cljs.core.some_QMARK_.call(null,only_after_9804));
if(db_changed_QMARK__9805){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_9803);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_9804);
...
var map__9812 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__9812__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__9812__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__9820 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__9820__$1;
var event = cljs.core.get.call(null,map__9820__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__7492__auto___9823 = arguments.length;
var i__7493__auto___9824 = (0);
while(true){
if((i__7493__auto___9824 < len__7492__auto___9823)){
args__7499__auto__.push((arguments[i__7493__auto___9824]));

var G__9825 = (i__7493__auto___9824 + (1));
i__7493__auto___9824 = G__9825;
continue;
} else {
}
break;
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq9822){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq9822));
});
...
var args__7499__auto__ = [];
var len__7492__auto___9831 = arguments.length;
var i__7493__auto___9832 = (0);
while(true){
if((i__7493__auto___9832 < len__7492__auto___9831)){
args__7499__auto__.push((arguments[i__7493__auto___9832]));

var G__9833 = (i__7493__auto___9832 + (1));
i__7493__auto___9832 = G__9833;
continue;
} else {
}
break;
...
return (function (p1__9826_SHARP_){
return cljs.core.get_in.call(null,new_db,p1__9826_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__9827_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__9827_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq9828){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__9829,G__9830,seq9828__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1502809962512