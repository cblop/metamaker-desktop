...
var G__14495 = devtools.prefs.pref.call(null,v);
v = G__14495;
continue;
} else {
return v;
...
}catch (e14508){var e__12009__auto__ = e14508;
return false;
}})();
...
}catch (e14512){var e__12009__auto__ = e14512;
return false;
}})();
...
}catch (e14514){var e__12009__auto__ = e14514;
return false;
}}
}
});
...
var vec__14519 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__14519,(0),null);
var name = cljs.core.nth.call(null,vec__14519,(1),null);
...
return cljs.core.some.call(null,(function (p1__14522_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__14522_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1502809978141