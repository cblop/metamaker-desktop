...
var G__40774 = devtools.prefs.pref.call(null,v);
v = G__40774;
continue;
} else {
return v;
...
var and__25084__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__25084__auto__){
var and__25084__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__25096__auto__ = (function (){try{if(!((value == null))){
...
}catch (e40787){var _e__39700__auto__ = e40787;
return false;
}})();
if(cljs.core.truth_(or__25096__auto__)){
return or__25096__auto__;
} else {
var or__25096__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e40791){var _e__39700__auto__ = e40791;
return false;
}})();
...
}catch (e40793){var _e__39700__auto__ = e40793;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__25084__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__25084__auto__)){
var and__25084__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__25084__auto____$1){
...
var and__25084__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__25084__auto__)){
...
var or__25096__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__25096__auto__)){
return or__25096__auto__;
} else {
...
var and__25084__auto__ = (function (){var or__25096__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__25096__auto__)){
return or__25096__auto__;
} else {
...
var vec__40798 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__40798,(0),null);
var name = cljs.core.nth.call(null,vec__40798,(1),null);
...
var and__25084__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__25084__auto__)){
...
var or__25096__auto__ = typeof value === 'string';
if(or__25096__auto__){
return or__25096__auto__;
} else {
var or__25096__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__40801_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__40801_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1504172211970