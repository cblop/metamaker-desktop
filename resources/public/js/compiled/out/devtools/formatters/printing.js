...
var len__26171__auto___40809 = arguments.length;
var i__26172__auto___40810 = (0);
while(true){
if((i__26172__auto___40810 < len__26171__auto___40809)){
args__26178__auto__.push((arguments[i__26172__auto___40810]));

var G__40811 = (i__26172__auto___40810 + (1));
i__26172__auto___40810 = G__40811;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__26179__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq40806){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__40807,G__40808,seq40806__$2);
});
...
if(cljs.core.truth_((function (){var or__25096__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__25702__auto__,writer__25703__auto__,opt__25704__auto__){
return cljs.core._write.call(null,writer__25703__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__25084__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__25084__auto__){
var or__25096__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__25096__auto__)){
return or__25096__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__40812_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__40812_SHARP_));
})))){
...
var markup_db = cljs.core.get.call(null,map__40821__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__25096__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e40825){var _e__39700__auto__ = e40825;
return false;
}})();
if(cljs.core.truth_(or__25096__auto__)){
return or__25096__auto__;
...
}catch (e40827){var _e__39700__auto__ = e40827;
return false;
}}
})())){
...
var _STAR_current_state_STAR_40832 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__40833 = opts;
var map__40833__$1 = ((((!((map__40833 == null)))?((((map__40833.cljs$lang$protocol_mask$partition0$ & (64))) || (map__40833.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__40833):map__40833);
var markup_db = cljs.core.get.call(null,map__40833__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_40832;
}});
...
;
var temp__4655__auto___40838 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___40838)){
var managed_print_level_40839 = temp__4655__auto___40838;
var _STAR_print_level_STAR_40837_40840 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_40839;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_40837_40840,managed_print_level_40839,temp__4655__auto___40838,writer,opts,job_fn){
return (function (p1__40835_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__40835_SHARP_,null);
});})(_STAR_print_level_STAR_40837_40840,managed_print_level_40839,temp__4655__auto___40838,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_40837_40840;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1504172212098