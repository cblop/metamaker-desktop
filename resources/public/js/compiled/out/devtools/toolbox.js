...
var args15491 = [];
var len__7492__auto___15497 = arguments.length;
var i__7493__auto___15498 = (0);
while(true){
if((i__7493__auto___15498 < len__7492__auto___15497)){
args15491.push((arguments[i__7493__auto___15498]));

var G__15499 = (i__7493__auto___15498 + (1));
i__7493__auto___15498 = G__15499;
continue;
} else {
}
break;
...
if(typeof devtools.toolbox.t_devtools$toolbox15494 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox15494 = (function (obj,header,style,tag,meta15495){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox15494.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_15496,meta15495__$1){
var self__ = this;
var _15496__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox15494(self__.obj,self__.header,self__.style,self__.tag,meta15495__$1));
});

devtools.toolbox.t_devtools$toolbox15494.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_15496){
var self__ = this;
var _15496__$1 = this;
return self__.meta15495;
});

devtools.toolbox.t_devtools$toolbox15494.prototype.devtools$protocols$IFormat$ = true;

devtools.toolbox.t_devtools$toolbox15494.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox15494.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox15494.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox15494.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta15495","meta15495",1747836082,null)], null);
});

devtools.toolbox.t_devtools$toolbox15494.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox15494.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox15494";

devtools.toolbox.t_devtools$toolbox15494.cljs$lang$ctorPrWriter = (function (this__7023__auto__,writer__7024__auto__,opt__7025__auto__){
return cljs.core._write.call(null,writer__7024__auto__,"devtools.toolbox/t_devtools$toolbox15494");
});

devtools.toolbox.__GT_t_devtools$toolbox15494 = (function devtools$toolbox$__GT_t_devtools$toolbox15494(obj__$1,header__$1,style__$1,tag__$1,meta15495){
return (new devtools.toolbox.t_devtools$toolbox15494(obj__$1,header__$1,style__$1,tag__$1,meta15495));
});

}

return (new devtools.toolbox.t_devtools$toolbox15494(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=toolbox.js.map?rel=1505229176907