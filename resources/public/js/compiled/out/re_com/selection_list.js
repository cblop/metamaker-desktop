...
var args11465 = [];
var len__7492__auto___11468 = arguments.length;
var i__7493__auto___11469 = (0);
while(true){
if((i__7493__auto___11469 < len__7492__auto___11468)){
args11465.push((arguments[i__7493__auto___11469]));

var G__11470 = (i__7493__auto___11469 + (1));
i__7493__auto___11469 = G__11470;
continue;
} else {
}
break;
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__11475){
var map__11478 = p__11475;
var map__11478__$1 = ((((!((map__11478 == null)))?((((map__11478.cljs$lang$protocol_mask$partition0$ & (64))) || (map__11478.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__11478):map__11478);
var args = map__11478__$1;
var disabled_QMARK_ = cljs.core.get.call(null,map__11478__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__11478__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var item_renderer = cljs.core.get.call(null,map__11478__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__11478__$1,new cljs.core.Keyword(null,"model","model",331153215));
var label_fn = cljs.core.get.call(null,map__11478__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__11478__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__11478__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var hide_border_QMARK_ = cljs.core.get.call(null,map__11478__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var choices = cljs.core.get.call(null,map__11478__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.call(null,map__11478__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var multi_select_QMARK_ = cljs.core.get.call(null,map__11478__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__11478,map__11478__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__11472_SHARP_){
return item_renderer.call(null,p1__11472_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__11478,map__11478__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__11478,map__11478__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__11473_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__11473_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__11478,map__11478__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:((function (selected,map__11478,map__11478__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__11474_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__11474_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__11478,map__11478__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
)),choices);
...
var len__7492__auto___11487 = arguments.length;
var i__7493__auto___11488 = (0);
while(true){
if((i__7493__auto___11488 < len__7492__auto___11487)){
args__7499__auto__.push((arguments[i__7493__auto___11488]));

var G__11489 = (i__7493__auto___11488 + (1));
i__7493__auto___11488 = G__11489;
continue;
} else {
}
break;
...
re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__11481){
...
var args = map__11482__$1;
if(cljs.core.truth_(((!(goog.DEBUG))?true:re_com.validate.validate_args.call(null,re_com.validate.extract_arg_data.call(null,re_com.selection_list.selection_list_args_desc),args,"selection-list")))){
} else {
throw (new Error("Assert failed: (validate-args-macro selection-list-args-desc args \"selection-list\")"));
}

return ((function (map__11482,map__11482__$1,args){
return (function() { 
var G__11490__delegate = function (p__11484){
var map__11485 = p__11484;
var map__11485__$1 = ((((!((map__11485 == null)))?((((map__11485.cljs$lang$protocol_mask$partition0$ & (64))) || (map__11485.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__11485):map__11485);
var args__$1 = map__11485__$1;
...
while (G__11491__i < G__11491__a.length) {G__11491__a[G__11491__i] = arguments[G__11491__i + 0]; ++G__11491__i;}
  p__11484 = new cljs.core.IndexedSeq(G__11491__a,0);
} 
return G__11490__delegate.call(this,p__11484);};
G__11490.cljs$lang$maxFixedArity = 0;
G__11490.cljs$lang$applyTo = (function (arglist__11492){
var p__11484 = cljs.core.seq(arglist__11492);
return G__11490__delegate(p__11484);
});
G__11490.cljs$core$IFn$_invoke$arity$variadic = G__11490__delegate;
return G__11490;
})()
;
;})(map__11482,map__11482__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq11480){
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq11480));
});


//# sourceMappingURL=selection_list.js.map?rel=1505229170540