...
var args11463 = [];
var len__7492__auto___11466 = arguments.length;
var i__7493__auto___11467 = (0);
while(true){
if((i__7493__auto___11467 < len__7492__auto___11466)){
args11463.push((arguments[i__7493__auto___11467]));

var G__11468 = (i__7493__auto___11467 + (1));
i__7493__auto___11467 = G__11468;
continue;
} else {
}
break;
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__11473){
var map__11476 = p__11473;
...
var args = map__11476__$1;
var disabled_QMARK_ = cljs.core.get.call(null,map__11476__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__11476__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var item_renderer = cljs.core.get.call(null,map__11476__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__11476__$1,new cljs.core.Keyword(null,"model","model",331153215));
var label_fn = cljs.core.get.call(null,map__11476__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__11476__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__11476__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var hide_border_QMARK_ = cljs.core.get.call(null,map__11476__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var choices = cljs.core.get.call(null,map__11476__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.call(null,map__11476__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var multi_select_QMARK_ = cljs.core.get.call(null,map__11476__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__11476,map__11476__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__11470_SHARP_){
return item_renderer.call(null,p1__11470_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__11476,map__11476__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__11476,map__11476__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__11471_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__11471_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__11476,map__11476__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:((function (selected,map__11476,map__11476__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__11472_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__11472_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__11476,map__11476__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
)),choices);
...
var len__7492__auto___11485 = arguments.length;
var i__7493__auto___11486 = (0);
while(true){
if((i__7493__auto___11486 < len__7492__auto___11485)){
args__7499__auto__.push((arguments[i__7493__auto___11486]));

var G__11487 = (i__7493__auto___11486 + (1));
i__7493__auto___11486 = G__11487;
continue;
} else {
}
break;
...
re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__11479){
...
var args = map__11480__$1;
if(cljs.core.truth_(((!(goog.DEBUG))?true:re_com.validate.validate_args.call(null,re_com.validate.extract_arg_data.call(null,re_com.selection_list.selection_list_args_desc),args,"selection-list")))){
} else {
throw (new Error("Assert failed: (validate-args-macro selection-list-args-desc args \"selection-list\")"));
}

return ((function (map__11480,map__11480__$1,args){
return (function() { 
var G__11488__delegate = function (p__11482){
...
while (G__11489__i < G__11489__a.length) {G__11489__a[G__11489__i] = arguments[G__11489__i + 0]; ++G__11489__i;}
  p__11482 = new cljs.core.IndexedSeq(G__11489__a,0);
} 
return G__11488__delegate.call(this,p__11482);};
G__11488.cljs$lang$maxFixedArity = 0;
G__11488.cljs$lang$applyTo = (function (arglist__11490){
var p__11482 = cljs.core.seq(arglist__11490);
return G__11488__delegate(p__11482);
});
G__11488.cljs$core$IFn$_invoke$arity$variadic = G__11488__delegate;
return G__11488;
})()
;
;})(map__11480,map__11480__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq11478){
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq11478));
});


//# sourceMappingURL=selection_list.js.map?rel=1502809968789