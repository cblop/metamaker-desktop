...
var args29899 = [];
var len__26171__auto___29902 = arguments.length;
var i__26172__auto___29903 = (0);
while(true){
if((i__26172__auto___29903 < len__26171__auto___29902)){
args29899.push((arguments[i__26172__auto___29903]));

var G__29904 = (i__26172__auto___29903 + (1));
i__26172__auto___29903 = G__29904;
continue;
} else {
}
break;
...
var base_style__$1 = (cljs.core.truth_((function (){var and__25084__auto__ = selected_QMARK_;
...
var base_style__$2 = (cljs.core.truth_((function (){var and__25084__auto__ = selected_QMARK_;
if(cljs.core.truth_(and__25084__auto__)){
...
if(cljs.core.truth_((function (){var and__25084__auto__ = required_QMARK_;
if(cljs.core.truth_(and__25084__auto__)){
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__29909){
var map__29912 = p__29909;
var map__29912__$1 = ((((!((map__29912 == null)))?((((map__29912.cljs$lang$protocol_mask$partition0$ & (64))) || (map__29912.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__29912):map__29912);
var args = map__29912__$1;
var disabled_QMARK_ = cljs.core.get.call(null,map__29912__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__29912__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var item_renderer = cljs.core.get.call(null,map__29912__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__29912__$1,new cljs.core.Keyword(null,"model","model",331153215));
var label_fn = cljs.core.get.call(null,map__29912__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__29912__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__29912__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var hide_border_QMARK_ = cljs.core.get.call(null,map__29912__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var choices = cljs.core.get.call(null,map__29912__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.call(null,map__29912__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var multi_select_QMARK_ = cljs.core.get.call(null,map__29912__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__29912,map__29912__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__29906_SHARP_){
return item_renderer.call(null,p1__29906_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__29912,map__29912__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__29912,map__29912__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__29907_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__29907_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__29912,map__29912__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:((function (selected,map__29912,map__29912__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__29908_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__29908_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__29912,map__29912__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
)),choices);
...
var len__26171__auto___29921 = arguments.length;
var i__26172__auto___29922 = (0);
while(true){
if((i__26172__auto___29922 < len__26171__auto___29921)){
args__26178__auto__.push((arguments[i__26172__auto___29922]));

var G__29923 = (i__26172__auto___29922 + (1));
i__26172__auto___29922 = G__29923;
continue;
} else {
}
break;
...
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(argseq__26179__auto__);
});

re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__29915){
...
var args = map__29916__$1;
if(cljs.core.truth_(((!(goog.DEBUG))?true:re_com.validate.validate_args.call(null,re_com.validate.extract_arg_data.call(null,re_com.selection_list.selection_list_args_desc),args,"selection-list")))){
} else {
throw (new Error("Assert failed: (validate-args-macro selection-list-args-desc args \"selection-list\")"));
}

return ((function (map__29916,map__29916__$1,args){
return (function() { 
var G__29924__delegate = function (p__29918){
...
while (G__29925__i < G__29925__a.length) {G__29925__a[G__29925__i] = arguments[G__29925__i + 0]; ++G__29925__i;}
  p__29918 = new cljs.core.IndexedSeq(G__29925__a,0);
} 
return G__29924__delegate.call(this,p__29918);};
G__29924.cljs$lang$maxFixedArity = 0;
G__29924.cljs$lang$applyTo = (function (arglist__29926){
var p__29918 = cljs.core.seq(arglist__29926);
return G__29924__delegate(p__29918);
});
G__29924.cljs$core$IFn$_invoke$arity$variadic = G__29924__delegate;
return G__29924;
})()
;
;})(map__29916,map__29916__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq29914){
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq29914));
});


//# sourceMappingURL=selection_list.js.map?rel=1504172200322